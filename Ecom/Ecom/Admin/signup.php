...
//sign up page for admin, admin can new admin
...
//inserting the user
    $sql = "INSERT INTO `users`( `user_name`,`fname`,`lname`, `password`, `email`, `address`, `Mobile`,`profile_id`) VALUES ('$uname','$fname','$lname','$password','$email','$address','$phone','2')";
